! function(e) {
    ...
    var a = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(e) {
                ...
                if (-1 !== n) {
                    var i = e.indexOf("<annotation", n + "<semantics>".length); - 1 !== i && (t = e.substring(0, n) + e.substring(n + "<semantics>".length, i) + "</math>")
                }
                return t
            }
        }, {
            ...
            value: function(e) {
                for (var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : o.xmlCharacters, n = "".concat(t.tagOpener, "math"), i = "".concat(t.tagOpener, "/math").concat(t.tagCloser), r = "/".concat(t.tagCloser), a = t.tagCloser, s = "".concat(t.tagOpener, "semantics").concat(t.tagCloser), l = "".concat(t.tagOpener, "annotation encoding="), c = "", u = e.indexOf(n), d = 0; - 1 !== u;) {
                    ...
                    var h = e.indexOf(i, u),
                        m = e.indexOf(r, u),
                        f = e.indexOf(a, u); - 1 !== h ? d = h : m === f - 1 && (d = m);
                    var g = e.indexOf(s, u);
                    if (-1 !== g) {
    ...
    var f = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(e, t) {
                ...
                return i ? (void 0 === t || void 0 === t ? i.open("GET", e, !1) : "/" === e.substr(0, 1) || "http://" === e.substr(0, 7) || "https://" === e.substr(0, 8) ? i.open("POST", e, !1) : i.open("POST", n + e, !1), void 0 !== t && t ? (i.setRequestHeader("Content-type", "application/x-www-form-urlencoded; charset=UTF-8"), i.send(w.httpBuildQuery(t))) : i.send(null), i.responseText) : ""
            }
        }, {
            key: "getService",
            value: function(t, n, i) {
    ...
    var p = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(t, n) {
                ...
                n && (o.saveLatex = "");
                var r, s = JSON.parse(f.getService("service", o));
                if ("ok" === s.status) {
                    var l = s.result.text;
            ...
            value: function(t, n) {
                for (var i, r, s, l = "", c = "".concat(n.tagOpener, "math"), u = "".concat(n.tagOpener, "/math").concat(n.tagCloser), d = "".concat(n.tagOpener, "annotation encoding=").concat(n.doubleQuote, "LaTeX").concat(n.doubleQuote).concat(n.tagCloser), h = "".concat(n.tagOpener, "/annotation").concat(n.tagCloser), m = t.indexOf(c), f = 0; - 1 !== m;) {
        ...
        return function(e, t, n) {
            ...
            value: function(e, t, n) {
                ...
                for (var o = e.indexOf("<".concat(t, " ")); - 1 !== o;) {
                    var r = void 0;
                    r = n ? ">" : "</".concat(t, ">");
                    var a = e.indexOf(r, o); - 1 !== a ? (a += r.length, i.push({
                        start: o,
                        end: a
                    })) : a = o + 1, o = e.indexOf("<".concat(t, " "), a)
                }
                return i
            }
        }, {
    ...
    var A = function() {
        ...
        return function(e, t, n) {
            ...
            value: function(e) {
                var t, n, i, o, r;
                for (w.readBytes(e, 0, 8); e.length >= 4;) 1229472850 === (i = w.readInt32(e)) ? (t = w.readInt32(e), n = w.readInt32(e), w.readInt32(e), w.readByte(e)) : 1650545477 === i ? o = w.readInt32(e) : 1883789683 === i && (r = w.readInt32(e), r = Math.round(r / 39.37), w.readInt32(e), w.readByte(e)), w.readInt32(e);
                if (void 0 !== t) {
                    var a = [];
        ...
        return function(e, t, n) {
            ...
            value: function(e, t) {
                ...
                return Object.keys(e).forEach(function(t) {
                    "mml" !== t && (o[t] = e[t])
                }), o.formula = com.wiris.js.JsPluginTools.md5encode(w.propertiesToString(n)), o.lang = void 0 === t ? "en" : t, o.version = l.get("version"), f.getService("showimage", w.httpBuildQuery(o), !0)
            }
        }, {
        ...
        return function(e, t, n) {
            ...
            value: function(e) {
                if (void 0 !== e.key && !1 === e.repeat)
                    ...
                    else "wrs_formulaDisplay wrs_focused" === document.getElementsByClassName("wrs_formulaDisplay")[0].getAttribute("class") && (this.modalDialogInstance.submitButton.focus(), e.stopPropagation(), e.preventDefault())
                }
            }
        }]), e
    }();
    ...
    var U = function() {
        function e(t) {
            ...
            m.id = this.getElementId(m.class), this.overlay = w.createElement("div", m), (m = {}).class = "wrs_modal_title_bar", m.id = this.getElementId(m.class), this.titleBar = w.createElement("div", m), (m = {}).class = "wrs_modal_title", m.id = this.getElementId(m.class), this.title = w.createElement("div", m), this.title.innerHTML = "", (m = {}).class = "wrs_modal_close_button", m.id = this.getElementId(m.class), m.title = b.get("close"), this.closeDiv = w.createElement("a", m), this.closeDiv.setAttribute("role", "button"), (m = {}).class = "wrs_modal_stack_button", m.id = this.getElementId(m.class), m.title = b.get("exit_fullscreen"), this.stackDiv = w.createElement("a", m), this.stackDiv.setAttribute("role", "button"), (m = {}).class = "wrs_modal_maximize_button", m.id = this.getElementId(m.class), m.title = b.get("fullscreen"), this.maximizeDiv = w.createElement("a", m), this.maximizeDiv.setAttribute("role", "button"), (m = {}).class = "wrs_modal_minimize_button", m.id = this.getElementId(m.class), m.title = b.get("minimize"), this.minimizeDiv = w.createElement("a", m), this.minimizeDiv.setAttribute("role", "button"), (m = {}).class = "wrs_modal_dialogContainer", m.id = this.getElementId(m.class), m.role = "dialog", this.container = w.createElement("div", m), this.container.setAttribute("aria-labeledby", "wrs_modal_title[0]"), (m = {}).class = "wrs_modal_wrapper", m.id = this.getElementId(m.class), this.wrapper = w.createElement("div", m), (m = {}).class = "wrs_content_container", m.id = this.getElementId(m.class), this.contentContainer = w.createElement("div", m), (m = {}).class = "wrs_modal_controls", m.id = this.getElementId(m.class), this.controls = w.createElement("div", m), (m = {}).class = "wrs_modal_buttons_container", m.id = this.getElementId(m.class), this.buttonContainer = w.createElement("div", m), this.submitButton = this.createSubmitButton({
            ...
            this.popup = new F(p), this.rtl = !1, "rtl" in this.attributes && (this.rtl = this.attributes.rtl), this.handleOpenedIosSoftkeyboard = this.handleOpenedIosSoftkeyboard.bind(this), this.handleClosedIosSoftkeyboard = this.handleClosedIosSoftkeyboard.bind(this)
        }
        return X(e, [{
    ...
    var J = function() {
        function e(t) {
            ...
            if (this.customEditors.addEditor("chemistry", {
                ...
                }(), this.listeners = new h, this.serviceProviderProperties = {}, !("serviceProviderProperties" in t)) throw new Error("serviceProviderProperties property missing.");
        ...
        return function(e, t, n) {
            ...
            value: function(e, t, n) {
                if (this.editionProperties.isNewElement)
                    ...
                    var d;
                    d = void 0 !== this.integrationModel.getSelectedItem ? this.integrationModel.getSelectedItem(t, !1) : w.getSelectedItemOnTextarea(t), w.updateExistingTextOnTextarea(t, e.textContent, d.startPosition, d.endPosition)
                } else e && "img" === e.nodeName.toLowerCase() ? (A.removeImgDataAttributes(this.editionProperties.temporalImage), A.clone(e, this.editionProperties.temporalImage)) : this.editionProperties.temporalImage.remove(), this.placeCaretAfterNode(this.editionProperties.temporalImage)
            }
        }, {
            key: "openModalDialog",
            value: function(e, t) {
                            ...
                            if (this.integrationModel.getMathmlFromTextNode) {
                                ...
                                if (c) {
                                    ...
                                    if ("textarea" !== e.tagName.toLowerCase())
                                        ...
                                        } else this.editionProperties.latexRange = d.document.createRange(), this.editionProperties.latexRange.setStart(c.startNode, c.startPosition), this.editionProperties.latexRange.setEnd(c.endNode, c.endPosition)
                                }
                            }
    ...
    var ee = function(e) {
        function t(e) {
            ...
            return function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, t), (n = Z(this, G(t).call(this, e))).integrationFolderName = "ckeditor_wiris", n
        }
        return function(e, t) {
            ...
            function(e, t, n) {
                ...
                value: function() {
                    ...
                    void 0 !== e.config.wirislistenersdisabled && e.config.wirislistenersdisabled ? (e.on("instanceReady", function(e) {
                        this.checkElement()
                    }.bind(this)), e.resetDirty()) : (e.setData(E.initParse(e.getData())), e.on("focus", function(e) {
                        WirisPlugin.currentInstance = WirisPlugin.instances[e.editor.name]
                    }), e.on("contentDom", function() {
                        e.on("doubleclick", function(e) {
                            ("img" == e.data.element.$.nodeName.toLowerCase() && w.containsClass(e.data.element.$, l.get("imageClassName")) || w.containsClass(e.data.element.$, l.get("CASClassName"))) && (e.data.dialog = null)
                        }.bind(this))
                    }.bind(this)), e.on("setData", function(e) {
                        e.data.dataValue = E.initParse(e.data.dataValue || "")
                    }.bind(this)), e.on("afterSetData", function(e) {
                        void 0 !== E.observer && Array.prototype.forEach.call(document.getElementsByClassName("Wirisformula"), function(e) {
    ...
    CKEDITOR.plugins.add("ckeditor_wiris", {
        init: function(e) {
            ...
            var t = "img[align,";
            t += l.get("imageMathmlAttribute"), t += ",src,alt](!Wirisformula)", e.addCommand("ckeditor_wiris_openFormulaEditor", {
                async: !1,
                canUndo: !0,
                editorFocus: !0,
                allowedContent: t,
                ...
                var t = {};
                t.editorObject = e, t.target = e.container.$.querySelector("*[class^=cke_wysiwyg]"), t.serviceProviderProperties = {}, t.serviceProviderProperties.URI = "https://www.wiris.net/demo/plugins/app", t.serviceProviderProperties.server = "java", t.version = "7.16.1.1426", t.scriptName = "plugin.js", t.environment = {}, t.environment.editor = "CKEditor4", "wiriscontextpath" in e.config && (t.configurationService = e.config.wiriscontextpath + t.configurationService, console.warn("Deprecated property wiriscontextpath. Use mathTypeParameters on instead.", e.config.wiriscontextpath)), "mathTypeParameters" in e.config && (t.integrationParameters = e.config.mathTypeParameters);
                var n = new ee(t);
    ...
    var ne = function() {
        ...
        return function(e, t, n) {
            ...
            value: function() {
                var e;
                console.log("Testing configuration service..."), console.log(f.getService("configurationjs", "", "get")), console.log("Testing showimage service..."), (e = []).mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(f.getService("showimage", e)), console.log("Testing createimage service..."), (e = []).mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(f.getService("createimage", e, "post")), console.log("Testing MathML2Latex service..."), (e = []).service = "mathml2latex", e.mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(f.getService("service", e)), console.log("Testing Latex2MathML service..."), (e = []).service = "latex2mathml", e.latex = "x^2", console.log(f.getService("service", e)), console.log("Testing Mathml2Accesible service..."), (e = []).service = "mathml2accessible", e.mml = '<math xmlns="http://www.w3.org/1998/Math/MathML"><msup><mi>x</mi><mn>2</mn></msup></math>', console.log(f.getService("service", e))
            }
        }]), e
    }();
    window.WirisPlugin = {
